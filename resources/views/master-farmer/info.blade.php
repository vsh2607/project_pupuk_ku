                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" required name="name" id="name" class="form-control my-input" placeholder="Nama Petani" value="{{ $data->name }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label class="required" for="land_type">Tipe Lahan</label>
                                <input type="text" name="land_type" id="land_type" class="form-control" value="{{ $data->land_type == "OWNED" ? "MILIK SENDIRI" : "GARAP ORANG LAIN" }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" required name="handphone_number" id="handphone_number" class="form-control my-input-int" placeholder="Nomor Handphone" value="{{ $data->handphone_number }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label class="required" for="land_area">Luas Lahan (m<sup>2</sup>)</label>
                                <input type="text" required name="land_area" id="land_area" class="form-control my-input-int" placeholder="Luas Lahan" value="{{ $data->land_area }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input required type="text" name="land_location" id="land_location" class="form-control my-input" placeholder="Lokasi Lahan" value="{{ $data->land_location }}" readonly>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input required type="text" name="fertilizer_quantity_owned" id="fertilizer_quantity_owned" class="form-control my-input-decimal" placeholder="Jumlah Pupuk Dimiliki" value="{{ $data->fertilizer_quantity_owned }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input required type="text" name="fertilizer_quantity_needed" id="fertilizer_quantity_needed" class="form-control my-input-decimal" placeholder="Jumlah Pupuk Dibutuhkan" value="{{ $data->fertilizer_quantity_needed }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
