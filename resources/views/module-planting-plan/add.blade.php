            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="code">Kode Perencanaan</label>
                                <input type="text" class="form-control" placeholder="AUTOGENERATED" readonly disabled>
                            </div>
                        </div>
            ...
            $("#id_master_farmer").on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#max-land-area-text").html('Sisa Maximum Luas Lahan Tersedia : ' + (
                                Number(response.land_area) - response.total_land_planned) +
                            ' m<sup>2</sup>');
