...
@section('title', 'Tambah Rencana Tanam')
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="date" required name="date" id="date" class="form-control my-input"
                                    placeholder="Tanggal Rencana Tanam"
            ...
            $("#id_master_farmer").on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#max-land-area-text").html('Sisa Maximum Luas Lahan Tersedia : ' + (Number(response.land_area) - response.total_land_planned) + ' m<sup>2</sup>');
                        maxLandArea = Number(response.land_area) - response.total_land_planned;
